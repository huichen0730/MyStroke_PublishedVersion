...
// create a component
export default class GripStrength extends Component {
    static navigationOptions = {
     ...
     if (this.state.patientCode){
          ...
          firebase.database().ref('assessment').push(
            {
              name: 'grip strength',
              description: 'measurement in KGs',
              patientCode: this.state.patientCode,
              rightHandStrength: this.state.rightHandStrength,
              leftHandStrength: this.state.leftHandStrength,
          ...
          >
            <View style={styles.container}>
              <Image source={require('../Logo/Logo_forward.png')}
                ...
                <Text style = {styles.title}>Grip Strength</Text>
            ...
            />
                ...
                <Text style = {styles.textExplain}> Measurement in KGs:</Text>

                <TextInput style={styles.inputCell2}
                value={this.state.rightHandStrength}
                onChangeText={(text) => {this.setState({rightHandStrength: text}) }}
                placeholder="  Right-hand strength"
            ...
            />
                 <TextInput style={styles.inputCell2}
                value={this.state.leftHandStrength}
                onChangeText={(text) => {this.setState({leftHandStrength: text}) }}
                placeholder="  Left-hand strength"
                keyboardType="numeric"
                clearButtonMode="always"
                autoCapitalize="none"
                autoCorrect={false}
