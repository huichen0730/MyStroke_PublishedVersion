...
// create a component
export default class BoxAndBlockTest extends Component {
          ...
          firebase.database().ref('assessment').push(
            {
              ...
              description: 'number of blocks in one minute',
              patientCode: this.state.patientCode,
              rightHandNumber: this.state.rightHandNumber,
              leftHandNumber: this.state.leftHandNumber,
          ...
          >
            <View style={styles.container}>
              <Image source={require('../Logo/Logo_forward.png')}
                ...
                <Text style = {styles.title}>Box And Block Test</Text>
            ...
            />
                ...
                <Text style = {styles.textExplain}>Number of blocks in one minute:</Text>

                <TextInput style={styles.inputCell2}
                value={this.state.rightHandNumber}
                onChangeText={(text) => {this.setState({rightHandNumber: text}) }}
                placeholder="    Right hand number"
            ...
            />
                 <TextInput style={styles.inputCell2}
                value={this.state.leftHandNumber}
                onChangeText={(text) => {this.setState({leftHandNumber: text}) }}
                placeholder="     Left hand number"
                keyboardType="numeric"
                clearButtonMode="always"
                autoCapitalize="none"
                autoCorrect={false}
