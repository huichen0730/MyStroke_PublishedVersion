...
// create a component
export default class TwoMinuteWalk extends Component {
          ...
          firebase.database().ref('assessment').push(
            {
              ...
              description: 'distance walked in two minutes in metres',
              patientCode: this.state.patientCode,
              metres: this.state.metres,
          ...
          >
            <View style={styles.container}>
              <Image source={require('../Logo/Logo_forward.png')}
                ...
                <Text style = {styles.title}>Two Minute Walk</Text>
            ...
            />
                ...
                <Text style = {styles.textExplain}>Distance walked in two minutes (in metres):</Text>

                <TextInput style={styles.inputCell2}
                value={this.state.metres}
                onChangeText={(text) => {this.setState({metres: text}) }}
