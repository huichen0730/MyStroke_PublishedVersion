...
// create a component
export default class BergBalanceScale extends Component {
          ...
          >
            <View style={styles.container}>
              <Image source={require('../Logo/Logo_forward.png')}
                ...
                <Text style = {styles.title}>Berg Balance Scale</Text>
